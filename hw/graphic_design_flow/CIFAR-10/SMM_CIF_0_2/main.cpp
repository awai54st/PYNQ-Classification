...
void SMM_2(hls::stream<AXI_VAL> &in_stream_a, hls::stream<AXI_VAL> &out_stream);
...
int main (){
	...
	const unsigned int Ker_DIM = 2;
	const unsigned int In_DIM = 4;
	const unsigned int In_CH = 1;
	const unsigned int Out_DIM = 3;
	...
	int kernel [Ker_DIM*Ker_DIM] = {-1,-1,0,-1};
